...
public class s2 {
    ...
    public static void main(String[] args) {
        ...
        double lat1= 31.1218065049;
        double lng1 = 121.3614050678;
        S2LatLng s2LatLng = S2LatLng.fromDegrees(lat1, lng1);
        S2CellId s2CellId = S2CellId.fromLatLng(s2LatLng);
        for (int i = 0; i < 10 ; i++) {
            System.out.println(s2CellId.level()+":"+s2CellId.toToken());
...
//        s2CellId.contains(s2CellId.childBegin());
//        s2CellId.parent();
//


        /*
        double lat2=31.1298193638;
        double lng2=121.3651704581;
        S2LatLng s2LatLng2 = S2LatLng.fromDegrees(lat2, lng2);
        S2CellId s2CellId2 = S2CellId.fromLatLng(s2LatLng2);

        System.out.println(Long.toBinaryString(s2CellId2.id()));

        long fk = s2CellId.id() ^ (s2CellId2.id());
        System.out.println(Long.toBinaryString(fk));
        int length =Long.toBinaryString(fk).length();
        long rs = s2CellId.id() >>> length << length;
        System.out.println(Long.toBinaryString(rs)+","+rs);


//        long kf = s2CellId.id() ^ (~s2CellId2.id());
//        System.out.println(Long.toBinaryString(kf));
...
*/
    ...
    private static void earthDisance() {
        //        2.1 计算地球上两个点之间的距离
        double lat = 22.629164;
        double lgt = 114.025514;
    ...
    private static void isInPolygon() {
    ...
    private static void inCircle() {
        ...
        S2LatLng s2LatLng1 = S2LatLng.fromDegrees(lat2, lng2);
        boolean contains = cap.contains(s2LatLng1.toPoint());
        System.out.println(contains);
    }


    private static void inPloygon() {
        String str = "114.025914,22.629364;114.027745,22.623408;114.028944,22.619712;114.030112,22.617669;114.033967,22.612966;114.042343,22.602816;114.046114,22.603997;114.048353,22.604289;114.049606,22.604455;114.050796,22.604898;114.051728,22.605412;114.053186,22.606647;114.054171,22.608369";
        double lat = 22.629164;
        double lgt = 114.025514;
        List<S2Point> vertices = new ArrayList<>();
